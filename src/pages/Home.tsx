    ...
    return <>
        <div className="mx-10">
            <div className="container p-8 mx-auto xl:px-0 flex flex-wrap ">
                <div className="flex items-center w-full lg:w-1/2">
                    <div className="max-w-2xl mb-8">
                        <h1
                            className="text-4xl font-bold leading-snug tracking-tight  lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
                            Free Landing Page Template for startups</h1>
                        <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">TestDemo
                            is a free landing page &amp; marketing website template for startups and indie projects. Its built
                            with Next.js &amp; TailwindCSS. And its completely open-source.</p>
                        <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
                            <Link to="#" target="_blank" rel="noopener"
                                className="px-8 py-4 text-lg font-medium text-center text-white bg-sky-900 rounded-md ">Download
                                for Free</Link>
                            <Link to="#" target="_blank" rel="noopener"
                                className="flex items-center space-x-2 text-gray-500 dark:text-gray-400">
                                <svg role="img" width="24" height="24" className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"
                ...
                <div className="flex items-center justify-center w-full lg:w-1/2">
                    <div className="">
                        <img className="object-cover h-[617] w-[617]" src="./images/hero.png" alt="Hero Illustration" />
                    </div>
                </div>
            </div>
            <div className="container p-8 mx-auto xl:px-0 ">
                <div className="flex flex-col justify-center">
                    <div className="text-xl text-center text-gray-700 dark:text-white">Trusted by <span
                        className="text-sky-600">2000+</span>
                        customers worldwide </div>
            ...
            <div className="container p-8 mx-auto xl:px-0 flex w-full flex-col mt-4 items-center justify-center text-center">
                <div className="text-sm font-bold tracking-wider text-sky-600 uppercase">TestDemo Benefits</div>
                <h2
                    className="max-w-2xl mt-3 text-3xl font-bold leading-snug tracking-tight  lg:leading-tight lg:text-4xl dark:text-white">
                    Why should you use this landing page</h2>
                <p className="max-w-2xl py-4 text-lg leading-normal text-gray-500 lg:text-xl xl:text-xl dark:text-gray-300">TestDemo
                    is a free landing page &amp; marketing website template for startups and indie projects. Its built with
            ...
            <div className="container p-8 mx-auto xl:px-0 flex flex-wrap mb-20 lg:gap-10 lg:flex-nowrap ">
                <div className="flex items-center justify-center w-full lg:w-1/2 ">
                    <div>
                        <img className="object-cover w-[521] width-[548]" src="./images/benefit-one.png" alt="Benefits" />
                    </div>
                </div>
                    ...
                    <div>
                        <div className="flex flex-col w-full mt-4">
                            <h3 className="max-w-2xl mt-3 text-3xl font-bold leading-snug tracking-tight  lg:leading-tight lg:text-4xl dark:text-white">
                                Highlight your benefits</h3>
                            <p className="max-w-2xl py-4 text-lg leading-normal text-gray-500 lg:text-xl xl:text-xl dark:text-gray-300">
                                You can use this space to highlight your first benefit or a feature of your product. It can also
                                contain an img or Illustration like in the example along with some bullet points.</p>
                        </div>
                        <div className="w-full mt-5">
                            <div className="flex items-start mt-8 space-x-3">
                                <div
                                    className="flex items-center justify-center flex-shrink-0 mt-1 bg-sky-900 rounded-md w-11 h-11 ">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                        aria-hidden="true" className="w-7 h-7 text-sky-50">
                                        <path fillRule="evenodd"
                                ...
                                <div>
                                    <h4 className="text-xl font-medium  dark:text-gray-200">Understand your customers
                                    </h4>
                                    <p className="mt-1 text-gray-500 dark:text-gray-400">Then explain the first point breifly in one
                                        or two lines. </p>
                                </div>
                            </div>
                            <div className="flex items-start mt-8 space-x-3">
                                ...
                                <div>
                                    <h4 className="text-xl font-medium  dark:text-gray-200">Improve acquisition</h4>
                                    <p className="mt-1 text-gray-500 dark:text-gray-400">Here you can add the next benefit point.
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-start mt-8 space-x-3">
                                <div className="flex items-center justify-center flex-shrink-0 mt-1 bg-sky-900 rounded-md w-11 h-11 ">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                        aria-hidden="true" className="w-7 h-7 text-sky-50">
                                        <path fillRule="evenodd"
                                ...
                                <div>
                                    <h4 className="text-xl font-medium  dark:text-gray-200">Drive customer retention
                                    </h4>
                                    <p className="mt-1 text-gray-500 dark:text-gray-400">This will be your last bullet point in this
                                        section.</p>
                                </div>
                            </div>
                        </div>
            ...
            <div className="container p-8 mx-auto xl:px-0 flex flex-wrap mb-20 lg:gap-10 lg:flex-nowrap ">
                <div className="flex items-center justify-center w-full lg:w-1/2 lg:order-1">
                    <div>
                        <img src="./images/benefit-two.png" alt="Benefits" loading="lazy" width="521" height="482" decoding="async" data-nimg="1"
                ...
                <div className="flex flex-wrap items-center w-full lg:w-1/2 ">
                    <div>
                        <div className="flex flex-col w-full mt-4">
                            <h3 className="max-w-2xl mt-3 text-3xl font-bold leading-snug tracking-tight  lg:leading-tight lg:text-4xl dark:text-white">
                                Offer more benefits here</h3>
                            <p className="max-w-2xl py-4 text-lg leading-normal text-gray-500 lg:text-xl xl:text-xl dark:text-gray-300">
                                You can use this same layout with a flip img to highlight your rest of the benefits of your
                                product. It can also contain an img or Illustration as above section along with some bullet
                                points.</p>
                        </div>
                        <div className="w-full mt-5">
                            <div className="flex items-start mt-8 space-x-3">
                                ...
                                <div>
                                    <h4 className="text-xl font-medium  dark:text-gray-200">Mobile Responsive Template
                                    </h4>
                                    <p className="mt-1 text-gray-500 dark:text-gray-400">TestDemo is designed as a mobile first
                            ...
                            <div className="flex items-start mt-8 space-x-3">
                                ...
                                <div>
                                    <h4 className="text-xl font-medium  dark:text-gray-200">Powered by Next.js &amp;
                                        TailwindCSS</h4>
                                    <p className="mt-1 text-gray-500 dark:text-gray-400">This template is powered by latest
                            ...
                            <div className="flex items-start mt-8 space-x-3">
                                ...
                                <div>
                                    <h4 className="text-xl font-medium  dark:text-gray-200">Dark &amp; Light Mode</h4>
                                    <p className="mt-1 text-gray-500 dark:text-gray-400">TestDemo comes with a zero-config light
                                        &amp; dark mode. </p>
                                </div>
                            </div>
                        </div>
            ...
            <div className="container p-8 mx-auto xl:px-0 flex w-full flex-col mt-4 items-center justify-center text-center">
                <div className="text-sm font-bold tracking-wider text-sky-600 uppercase">Watch a video</div>
                <h2
                    className="max-w-2xl mt-3 text-3xl font-bold leading-snug tracking-tight  lg:leading-tight lg:text-4xl dark:text-white">
                    Learn how to fullfil your needs</h2>
                <p className="max-w-2xl py-4 text-lg leading-normal text-gray-500 lg:text-xl xl:text-xl dark:text-gray-300">This
                    section is to highlight a promo or demo video of your product. Analysts says a landing page with video has
                    3% more conversion rate. So, don't forget to add one. Just like this.</p>
            </div>
            <div className="container p-8 mx-auto xl:px-0 ">
                <div className="w-full max-w-4xl mx-auto overflow-hidden lg:mb-20 rounded-2xl ">
                    <div
                        ...
                        <button
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-16 h-16  lg:w-28 lg:h-28" viewBox="0 0 20 20"
                                fill="currentColor">
                                <path fillRule="evenodd"
            ...
            <div className="container p-8 mx-auto xl:px-0 flex w-full flex-col mt-4 items-center justify-center text-center">
                <div className="text-sm font-bold tracking-wider text-sky-600 uppercase">Testimonials</div>
            ...
            <div className="container p-8 mx-auto xl:px-0 ">
                <div className="grid gap-10 lg:grid-cols-2 xl:grid-cols-3">
                    <div className="lg:col-span-2 xl:col-auto">
                        <div
                            className="flex flex-col justify-between w-full h-full bg-gray-100 px-14 rounded-2xl py-14 dark:bg-slate-800">
                            <p className="text-2xl leading-normal ">Share a real

                                <mark
                                    className="text-sky-800 bg-sky-100 rounded-md ring-sky-100 ring-4 dark:ring-sky-900 dark:bg-sky-900 dark:text-sky-200">testimonial</mark>
                                that hits some of your benefits from one of your popular customer.
                            </p>
                            <div className="flex items-center mt-8 space-x-3">
                                <div className="flex-shrink-0 overflow-hidden rounded-full w-14 h-14">
                                    <img src="./images/user1.jpeg" alt="Avatar" loading="lazy" width="40" height="40" decoding="async" data-nimg="1" />
                                </div>
                                <div>
                    ...
                    <div className="">
                        <div
                            className="flex flex-col justify-between w-full h-full bg-gray-100 px-14 rounded-2xl py-14 dark:bg-slate-800">
                            <p className="text-2xl leading-normal ">Make sure you only pick the

                                <mark
                                    className="text-sky-800 bg-sky-100 rounded-md ring-sky-100 ring-4 dark:ring-sky-900 dark:bg-sky-900 dark:text-sky-200">right
                                    sentence</mark>
                    ...
                    <div className="">
                        <div
                            className="flex flex-col justify-between w-full h-full bg-gray-100 px-14 rounded-2xl py-14 dark:bg-slate-800">
                            <p className="text-2xl leading-normal ">This is an

                                <mark
                                    className="text-sky-800 bg-sky-100 rounded-md ring-sky-100 ring-4 dark:ring-sky-900 dark:bg-sky-900 dark:text-sky-200">awesome</mark>
            ...
            <div className="container p-8 mx-auto xl:px-0 flex w-full flex-col mt-4 items-center justify-center text-center">
                <div className="text-sm font-bold tracking-wider text-sky-600 uppercase">FAQ</div>
                <h2
                    className="max-w-2xl mt-3 text-3xl font-bold leading-snug tracking-tight  lg:leading-tight lg:text-4xl dark:text-white">
                    Frequently Asked Questions</h2>
                <p className="max-w-2xl py-4 text-lg leading-normal text-gray-500 lg:text-xl xl:text-xl dark:text-gray-300">Answer
                    your customers possible questions here, it will increase the conversion rate as well as support or chat
                    requests.</p>
            </div>
            <div className="container p-8 mx-auto xl:px-0 ">
                <div className="w-full max-w-2xl p-2 mx-auto rounded-2xl">
                    <div className="mb-5">
                        <button
                            className="flex items-center justify-between w-full px-4 py-4 text-lg text-left  rounded-lg bg-gray-50 hover:bg-gray-100 focus:outline-none focus-visible:ring focus-visible:ring-sky-100 focus-visible:ring-opacity-75 dark:bg-slate-800 dark:text-gray-200"
                            id="headlessui-disclosure-button-:R174m:" type="button" aria-expanded="false"
                            data-headlessui-state="">
                            <span>Is this template completely free to use?</span>
                    ...
                    <div className="mb-5">
                        <button
                            className="flex items-center justify-between w-full px-4 py-4 text-lg text-left  rounded-lg bg-gray-50 hover:bg-gray-100 focus:outline-none focus-visible:ring focus-visible:ring-sky-100 focus-visible:ring-opacity-75 dark:bg-slate-800 dark:text-gray-200"
                            id="headlessui-disclosure-button-:R1b4m:" type="button" aria-expanded="false"
                            data-headlessui-state="">
                    ...
                    <div className="mb-5">
                        <button
                            className="flex items-center justify-between w-full px-4 py-4 text-lg text-left  rounded-lg bg-gray-50 hover:bg-gray-100 focus:outline-none focus-visible:ring focus-visible:ring-sky-100 focus-visible:ring-opacity-75 dark:bg-slate-800 dark:text-gray-200"
                            id="headlessui-disclosure-button-:R1f4m:" type="button" aria-expanded="false"
                            data-headlessui-state="">
                    ...
                    <div className="mb-5">
                        <button
                            className="flex items-center justify-between w-full px-4 py-4 text-lg text-left  rounded-lg bg-gray-50 hover:bg-gray-100 focus:outline-none focus-visible:ring focus-visible:ring-sky-100 focus-visible:ring-opacity-75 dark:bg-slate-800 dark:text-gray-200"
                            id="headlessui-disclosure-button-:R1j4m:" type="button" aria-expanded="false"
                            data-headlessui-state="">
            ...
            <div className="container p-8 mx-auto xl:px-0 ">
                <div
                    className="flex flex-wrap items-center justify-between w-full max-w-4xl gap-5 mx-auto text-white bg-sky-900 dark:bg-sky-600/10 px-7 py-7 lg:px-12 lg:py-12 lg:flex-nowrap rounded-xl">
                    <div className="flex-grow text-center lg:text-left">
                        <h2 className="text-2xl font-medium lg:text-3xl">Ready to try-out this template?</h2>
                        <p className="mt-2 font-medium text-white text-opacity-90 lg:text-xl">Don't let your visitors see a poor
                            landing. </p>
                    </div>
                    <div className="flex-shrink-0 w-full text-center lg:w-auto">
                        <Link to="#" target="_blank" rel="noopener"
                            className="inline-block py-3 mx-auto text-lg font-medium text-center text-sky-600 bg-white dark:bg-sky-900 dark:text-white rounded-md px-7 lg:px-10 lg:py-5 ">Download
                            for Free</Link>
                    </div>
                </div>
            </div>
